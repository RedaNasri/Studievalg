...
const fagomraader = ['Annen helse','BioingeniÃ¸r','Cybersikkerhet','Data og IT','Farmasi','Film og media','Fysioterapi','Idrett','Teknologi','Journalistikk','Lov og orden','Kunst og design','Kunstig intelligens','LÃ¦rer','MarkedsfÃ¸ring','Matematikk','Medisin','Musikk','Helse','Realfag','Regnskap','Samfunn','Sosiologi','SprÃ¥k','Statsvitenskap','Sykepleie','Tannhelse','Ã˜konomi','Annet']
...
const masterFagomraader = ['Helse','Idrett','IT og data','Teknologi','Lov og orden','Kunst og kultur','Media og kommunikasjon','Pedagogikk','Helse','Realfag','Samfunn','SprÃ¥k','Ã˜konomi']
const masterByer = ['Oslo','Bergen','Trondheim','TromsÃ¸','Stavanger','Kristiansand','GjÃ¸vik']
...
const bachelorTilKategori: any = {'Bachelor i Ã¸konomi og administrasjon':'Ã˜konomi','Bachelor i regnskap og revisjon':'Ã˜konomi','Bachelor i markedsfÃ¸ring og ledelse':'Ã˜konomi','Bachelor i internasjonal business':'Ã˜konomi','Bachelor i finans':'Ã˜konomi','Bachelor i rettsvitenskap / jus':'Lov og orden','Bachelor i psykologi':'Helse','Bachelor i sosiologi':'Samfunn','Bachelor i statsvitenskap':'Samfunn','Bachelor i samfunnsÃ¸konomi':'Ã˜konomi','Bachelor i filosofi':'Samfunn','Bachelor i pedagogikk':'Pedagogikk','Bachelor i informatikk':'IT og data','Bachelor i datateknologi':'IT og data','Bachelor i kunstig intelligens':'IT og data','Bachelor i cybersikkerhet':'IT og data','Bachelor i ingeniÃ¸r â€“ data':'Teknologi','Bachelor i ingeniÃ¸r â€“ maskin':'Teknologi','Bachelor i ingeniÃ¸r â€“ bygg':'Teknologi','Bachelor i ingeniÃ¸r â€“ elektronikk':'Teknologi','Bachelor i ingeniÃ¸r â€“ energi':'Teknologi','Bachelor i matematikk':'Realfag','Bachelor i fysikk':'Realfag','Bachelor i kjemi':'Realfag','Bachelor i biologi':'Realfag','Bachelor i bioteknologi':'Realfag','Bachelor i sykepleie':'Helse','Bachelor i ergoterapi':'Helse','Bachelor i fysioterapi':'Helse','Bachelor i bioingeniÃ¸r':'Helse','Bachelor i radiografi':'Helse','Bachelor i paramedisin':'Helse','Bachelor i farmasi':'Helse','Bachelor i tannpleie':'Helse','Bachelor i folkehelse':'Helse','Bachelor i barnevern':'Helse','Bachelor i sosialt arbeid':'Helse','Bachelor i vernepleie':'Helse','Bachelor i journalistikk':'Media og kommunikasjon','Bachelor i medievitenskap':'Media og kommunikasjon','Bachelor i kommunikasjon':'Media og kommunikasjon','Bachelor i film og TV-produksjon':'Media og kommunikasjon','Bachelor i kunst og design':'Kunst og kultur','Bachelor i arkitektur':'Kunst og kultur','Bachelor i musikkvitenskap':'Kunst og kultur','Bachelor i idrettsvitenskap':'Idrett','Bachelor i friluftsliv':'Idrett','Bachelor i lÃ¦rerutdanning 1â€“7':'Pedagogikk','Bachelor i lÃ¦rerutdanning 5â€“10':'Pedagogikk','Bachelor i historie':'Samfunn','Bachelor i geografi':'Samfunn','Bachelor i nordisk sprÃ¥k og litteratur':'SprÃ¥k','Bachelor i engelsk':'SprÃ¥k','Bachelor i fransk':'SprÃ¥k','Bachelor i tysk':'SprÃ¥k','Bachelor i spansk':'SprÃ¥k','Bachelor i arabisk':'SprÃ¥k','Bachelor i kinesisk':'SprÃ¥k','Bachelor i russisk':'SprÃ¥k','Bachelor i landbruk':'Realfag','Bachelor i havbruk':'Realfag','Bachelor i veterinÃ¦rmedisin':'Helse','Bachelor i miljÃ¸vitenskap':'Realfag','Bachelor i geologi':'Realfag','Bachelor i nanoteknologi':'Realfag'}
